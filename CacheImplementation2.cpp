...
int main(int argc, const char * argv[]) {
    ...
    if ( cash_type==0)   //Direct_mapped **************
    {
      ...
      high_resolution_clock::time_point t1 = high_resolution_clock::now();
        ...
        cout << "Average Time taken : " << (time_span.count()/(float)(hit_counter+compulsry_misses+capcity_misses+conflict_misses)) << " seconds." << endl;


    cout << "Hits : " << hit_counter<<endl << "Compulsry Misses :  " << compulsry_misses <<endl<< "Capcity Misses:  " << capcity_misses <<endl<< "Conflic Misses :  " << conflict_misses <<  endl;
    float hit_rate = (float)(hit_counter)/(float)(hit_counter+compulsry_misses+capcity_misses+conflict_misses);
    ...
    else if (cash_type==2)  //  Fully associative**************
    {
      ...
      high_resolution_clock::time_point t1 = high_resolution_clock::now();
        ...
        cout << "Hits : " << hit_counter<<endl << "Compulsry Misses :  " << compulsry_misses <<endl<< "Capcity Misses :  " << capcity_misses <<endl<< "Conflict Misses :  " << conflict_misses <<  endl;
        float hit_rate = (float)(hit_counter)/(float)(hit_counter+compulsry_misses+capcity_misses+conflict_misses);
        cout<< "Hit Rate : " << hit_rate << endl;
